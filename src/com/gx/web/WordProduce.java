...
public class WordProduce {
	...
	public ResponseEntity<byte[]> wlInstallWord(HttpServletRequest request, @RequestParam("id") Integer id)
			throws Exception {
	...
	public ResponseEntity<byte[]> wlSurveyWord(HttpServletRequest request, @RequestParam("id") Integer id)
			throws Exception {
	...
	public ResponseEntity<byte[]> ppSurveyWord(HttpServletRequest request, @RequestParam("id") Integer id)
			throws Exception {
	...
	public ResponseEntity<byte[]> wlFixWord(HttpServletRequest request, @RequestParam("id") Integer id)
			throws Exception {
	...
	public ResponseEntity<byte[]> ppFixWord(HttpServletRequest request, @RequestParam("id") Integer id)
			throws Exception {
	...
	public ResponseEntity<byte[]> yaKouWord(HttpServletRequest request, @RequestParam("id") Integer id)
			throws Exception {
